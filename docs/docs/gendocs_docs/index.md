...
#Â get t-test results
ora.ttest_res

#Â obtain list of differential molecules input to ORA
ora.DA_molecules
```
...
```
@article{Wieder22a,
   author = {Cecilia Wieder and Nathalie Poupin and ClÃ©ment Frainay and Florence Vinson and Juliette Cooke and Rachel PJ Lai and Jacob G Bundy and Fabien Jourdan and Timothy MD Ebbels},
